...
export const useBillingSelectors = () => {
	...
	const currentPlan = useBillingStore((state) => state.currentPlan)
	const billingHistory = useBillingStore((state) => state.billingHistory)
	const getCurrentPlan = useBillingStore((state) => state.getCurrentPlan)
	const getNextPlan = useBillingStore((state) => state.getNextPlan)
